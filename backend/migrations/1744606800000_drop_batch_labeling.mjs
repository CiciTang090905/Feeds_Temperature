...
export const down = (pgm) => {
    ...
    pgm.sql("UPDATE posts SET stage_b_status='done' WHERE is_political=1 AND partisan_animosity IS NOT NULL");
    pgm.sql("UPDATE posts SET stage_b_status='pending' WHERE is_political=1 AND partisan_animosity IS NULL");
    pgm.sql("UPDATE posts SET stage_b_status='n/a' WHERE is_political=0");
};
